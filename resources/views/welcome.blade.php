    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap items-center">
        <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
          <div class="relative flex flex-col min-w-0 break-words bg-dark w-full mb-6  rounded-full">
            <img alt="profile" src="{{URL::asset('/image/suwat.jpg')}}" class="rounded-full">
        ...
        <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
            ...
            <p class="block max-w-2xl mt-4 text-xl text-gray-500">  Web Developer passionate about creating and experiences on the web.</p>

            <div class="mt-6 sm:-mx-2">


                <div class="inline-flex w-full mt-4 overflow-hidden rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0">
                    <a href="#" class="inline-flex items-center justify-center w-full px-5 py-3 text-base font-medium text-dark transition-colors duration-150 transform sm:w-auto bg-gradient-to-r hover:from-blue-600 hover:to-blue-600">
